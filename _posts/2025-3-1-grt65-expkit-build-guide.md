...
![スクロール設定](/assets/images/grt65-expkit/keymap-scroll.jpg)
...
![layer-0-3finger](/assets/images/grt65-expkit/keymap-3finger.jpg)
...
|`R0` - `R270` | トラックパッドの向きの設定に使用します。設定以外には使用できません。 |
